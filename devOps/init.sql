...
\copy gate_assignments (time, airline, flight_number, transaction, terminal, gate, remark) FROM '/tmp/gate_assignments_init.csv' DELIMITER ';' CSV HEADER;

SELECT time, airline, flight_number, transaction, terminal, gate, remark
