...
describe('Component Tests', () => {
  describe('GateAssignments Management Component', () => {
    let comp: GateAssignmentsComponent;
    let fixture: ComponentFixture<GateAssignmentsComponent>;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gateAssignments && comp.gateAssignments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
